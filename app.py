...
def remove_past_appointments():
    if os.path.exists('appointments.csv'):
        ...
        # Read and filter out past appointments
        ...
        print("No appointments to remove.")
...
def schedule_appointment():
    ...
    if response == "yes":
        ...
        try:
            ...
            print(f"Appointment scheduled successfully for {name} on {appointment_date} at {appointment_time}.")
        except ValueError:
...
def show_appointment_list():
    remove_past_appointments()  # Ensure past appointments are removed before displaying
    if os.path.exists('appointments.csv'):
...
def start_conversation():
    while True:
        ...
        if user_input == "hi":
            ...
            print("Please type 'hi' to start the conversation.")
...
print("----------------------------------------------------------------------------------------")
print("Would you like to view the list of scheduled appointments? (yes/no): ", end="")
